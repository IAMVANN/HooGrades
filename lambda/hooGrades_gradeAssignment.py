...
#         ],
#     )
#     resp_status = response.choices[0].message.content["grade"]
#     resp_feedback = response.choices[0].message.content["feedback"]
#     print(resp_status, resp_feedback)
#     response = table.update_item(
#         Key={
#             "assignment_id": assignment_id,
#         },
#         UpdateExpression="SET feedback = :fb, status = :stat",
#         ExpressionAttributeValues={
#             ":fb": resp_feedback,
#             ":stat": resp_status,  # Setting the status to "submitted"
#         },
...
def getAssignmentsByCourse(
    ...
    try:
        ...
        for assignment_id in course["Item"]["assignments"]:
            ...
            if assignment["Item"]["assignment_name"] == input_assignment_name and assignment["Item"]["status"] == "submitted":
                rubric = ""
...
def lambda_handler(event, context):
    ...
    if status == 2:
        ...
        response["body"] = json.dumps({"toGrade": status})
